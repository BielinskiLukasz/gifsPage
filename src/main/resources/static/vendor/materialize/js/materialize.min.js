    ...
    a.fn.scrollTo = function (b) {
        ...
        this.each(function () {
            ...
            function e() {
                ...
                if (j + i.innerWidth() > a(window).width() ? h.alignment = "right" : j - i.innerWidth() + g.innerWidth() < 0 && (h.alignment = "left"), "left" === h.alignment) e = 0, f = h.gutter, c = g.position().left + e + f, i.css({left: c}); else if ("right" === h.alignment) {
                    a(window).width() - j - g.innerWidth();
                    e = 0, f = h.gutter, c = a(window).width() - g.position().left - g.innerWidth() + f, i.css({right: c})
                }
                i.css({
                    position: "absolute",
                ...
                "mouseenter.tooltip": function (a) {
                    ...
                    g = void 0 === g || "" === g ? b.delay : g, c = 0, e = setInterval(function () {
                        if (c += 10, c >= g && d === !1) {
                            ...
                            var a = h.outerWidth(), b = h.outerHeight(), e = h.attr("data-position"),
                                i = j.outerHeight(), l = j.outerWidth(), m = "0px", n = "0px", o = 8;
                            "top" === e ? (j.css({
                                ...
                                left: h.offset().left + a / 2 - l / 2
                            }), m = "+10px", k.css({marginLeft: l / 2 - k.width() / 2})), o = l / 8, 8 > o && (o = 8), ("right" === e || "left" === e) && (o = l / 10, 6 > o && (o = 6)), j.velocity({
                                marginTop: m,
                                marginLeft: n
                                ...
                                delay: 50,
                                queue: !1
                            }), k.css({display: "block"}).velocity({opacity: 1}, {
                                duration: 55,
                                delay: 0,
                                queue: !1
                    ...
                    clearInterval(e), c = 0, j.velocity({opacity: 0, marginTop: 0, marginLeft: 0}, {
                        duration: 225,
                        queue: !1,
                        delay: 225
                    }), k.velocity({opacity: 0, scale: 1}, {
                        duration: 225,
                        delay: 275,
                        queue: !1,
                        complete: function () {
    ...
    a(document).ready(function () {
        ...
        a(this).each(function () {
            if ($select = a(this), !$select.hasClass("browser-default")) {
                ...
                $select.before(k), k.before(i), a("body").append(g), $select.is(":disabled") || k.dropdown({hover: !1}), $select.attr("tabindex") && a(k[0]).attr("tabindex", $select.attr("tabindex")), $select.addClass("initialized"), k.on("focus", function () {
